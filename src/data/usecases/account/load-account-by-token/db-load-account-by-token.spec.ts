import { AccountModel, Decrypter, LoadAccountByTokenRepository } from './db-load-survey-by-token-protocols'
...
describe('DbLoadAccountByToken Usecase', () => {
  ...
  test('Should throw if LoadByAccountRepository throws', async () => {
    const { sut, loadAccountByTokenRepositoryStub } = makeSut()
